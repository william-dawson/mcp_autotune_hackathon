...
test-correctness: lj_benchmark
	...
	@if grep -q "Total Lennard-Jones energy: 5247014662763.571289" /tmp/lj_output.txt && \
	    grep -q "Number of particles: 1000" /tmp/lj_output.txt && \
	    grep -q "Number of interactions: 499500" /tmp/lj_output.txt; then \
